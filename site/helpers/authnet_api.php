...
/**
   ...
   */
  public function merchant_authentication_block($authnet_login, $authnet_transaction_key)
  {
    return
  ...
  public static function send_xml_request($content)
  {
   ...
   * NEEDS WORK!!
   */
  public static function parse_api_response($content)
  {
